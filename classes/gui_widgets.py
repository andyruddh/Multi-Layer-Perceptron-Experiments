...
"            }")
        ...
        self.resetalgorithmbutton = QtWidgets.QPushButton(self.frame_3)
        self.resetalgorithmbutton.setGeometry(QtCore.QRect(50, 45, 201, 31))
        self.resetalgorithmbutton.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.resetalgorithmbutton.setStyleSheet("\n"
"QPushButton {\n"
"                color: rgb(255, 255, 255);\n"
"                background-color: rgb(0, 0, 255);\n"
"                border-style: outset;\n"
...
"                padding-top: 5px;\n"
"            }")
        self.resetalgorithmbutton.setCheckable(False)
        self.resetalgorithmbutton.setObjectName("resetalgorithmbutton")
...
"            }")
        ...
        self.Nbox = QtWidgets.QSpinBox(self.trackerparamsframe)
        self.Nbox.setGeometry(QtCore.QRect(200, 80, 61, 21))
        self.Nbox.setMinimum(1)
        self.Nbox.setMaximum(200)
        self.Nbox.setSingleStep(1)
        self.Nbox.setProperty("value", 1)
        self.Nbox.setDisplayIntegerBase(10)
        self.Nbox.setObjectName("Nbox")
        self.alpha_2 = QtWidgets.QLabel(self.trackerparamsframe)
        self.alpha_2.setGeometry(QtCore.QRect(220, 50, 81, 25))
        self.alpha_2.setMaximumSize(QtCore.QSize(150, 25))
...
"            }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resetalgorithmbutton.setText(_translate("MainWindow", "Reset Algorithm"))
        ...
        self.alpha_2.setText(_translate("MainWindow", "N"))
